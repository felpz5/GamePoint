...
class LojaJogos(ctk.CTk):
    def __init__(self):
        ...
        self.carregar_dados()
        self.protocol("WM_DELETE_WINDOW", self.salvar_dados_ao_fechar)
    ...
    def salvar_dados_ao_fechar(self):
        self.salvar_dados()
        self.destroy()
    ...
    def criar_tela_principal(self):
        ...
        botao_sair = ctk.CTkButton(self.frame_inicio, text="Sair", width=150, height=40, font=("Roboto", 14),
                                   fg_color="#b83232", hover_color="#ff4d4d", corner_radius=10, command=self.salvar_dados_ao_fechar)
    ...
    def criar_tela_jogos(self):
        ...
        # Adição estratégica: Barra de busca para jogos
    ...
    def criar_tela_admin(self):
        ...
        # Adição estratégica: Gerenciar usuários
    ...
    def atualizar_lista_usuarios(self):
        ...
        for user, data in usuarios.items():
            if user == "admin":
                continue  # Não permite editar/excluir admin
    ...
    def criar_tela_relatorios(self):
        ...
        # Adição estratégica: Total de vendas
    ...
    def criar_tela_cliente(self):
        ...
        # Adição estratégica: Ver histórico de compras
